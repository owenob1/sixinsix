...
@section('content')
	...
	<section id="who" class="section-double left">
		<div class="col-md-6 content">
			<h2>Who is it for?</h2>
			<p class="lead">We have specifically designed this plan to take online businesses from launch to earning up to six figures or more within six months. Whether you are just beginning or already own a multi-million dollar company, our <a href="#process">processes</a>				can be repeated and used to help any business hit their desired goals.</p>
			<p class="lead">This is not a get rich quick scheme. This is not an online course. Everything we do is going to be tailored to YOU and your business. We have successfully used these methods and online strategies to grow our own companies, and now we have decided to
				break it down and show you how to do the same. </p>
	...
	<section id="process1" class="section-double right">
		<div class="col-md-6 content">
			...
			<p class="lead">We are going to completely audit and analyse your business. We often find businesses are already sitting on a solution for rapid growth and it's time to activate it. We will test your site and analyse the traffic to understand exactly who your customers
				are.</p>
	...
	<section id="process2" class="section-double left">
		<div class="col-md-6 content">
			...
			<p class="lead">In this stage we are going to be taking all the data we've collected on your business, and use it to create insanely effective online marketing campaigns that actually work. We will be implementing strategies in both paid and organic traffic. This
